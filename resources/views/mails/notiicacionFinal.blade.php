...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="tamano">
            ...
            <div class="contenido">
                <p style="display: none">{{$valor = $msg['estado']}}</p>
                <p style="display: none">{{$valor2 = $msg['prioridad']}}</p>

                <h4 class="">Soporte Realizado Con Éxito!!</h4>
                ...
                <p class=""><span>Fecha y Hora Final:</span> {{$msg['fechaFinalAsistencia']}}</p>
                ...
                @if ($valor == 'Asignado')
                    <p class=""><span>Estado:</span> <span style="font-weight: bolder">{{$msg['estado']}}</span></p>
                @elseif ($valor == 'En Proceso')
                    <p class=""><span>Estado:</span> <span style="color: rgb(19, 58, 156); font-weight: bolder">{{$msg['estado']}}</span></p>
                @else
                    <p class=""><span>Estado:</span> <span style="color: green; font-weight: bolder">{{$msg['estado']}}</span></p>
                @endif
